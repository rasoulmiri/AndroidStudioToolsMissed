...
class LimitationModesModuleTest : KoinTest {
    ...
    private val preDependencies =
        coroutinesDispatcherIOModule +
                ...
                adbManagerModule +
                deviceManagerModule
    private val testModule = preDependencies + limitationModesModule
    ...
    private val limitationModesViewModel: LimitationModesViewModel by inject()
    ...
    @Test
    fun `limitationModesViewModel should not be null`() {
        assertNotNull(limitationModesViewModel)
    }

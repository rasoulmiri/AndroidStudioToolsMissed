package androidstudio.tools.missed.features.limitationmodes.presenter

import androidstudio.tools.missed.base.CollapsibleGroupView
import androidstudio.tools.missed.features.limitationmodes.presenter.whitelistdialog.WhiteListDialog
...
class LimitationModesView(
    override val viewModel: LimitationModesViewModel,
    private val notificationManager: NotificationManager,
    private val resourceManager: ResourceManager
) : CollapsibleGroupView<LimitationModesViewModel>(viewModel) {
    ...
    init {
        setContent(
            title = resourceManager.string("limitationModesTitle"),
            dozeView(),
            standbyView(),
            whiteListView()
        )

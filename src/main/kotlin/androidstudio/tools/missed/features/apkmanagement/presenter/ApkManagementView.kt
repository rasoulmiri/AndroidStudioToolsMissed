...
class ApkManagementView(
    override val viewModel: ApkManagementViewModel,
    private val notificationManager: NotificationManager,
    private val resourceManager: ResourceManager
) : CollapsibleGroupView<ApkManagementViewModel>(viewModel) {
    ...
    init {
        setContent(
            title = resourceManager.string("apkManagementTitle"),
            downloadView(),
            installView()
        )
    }

...
import androidstudio.tools.missed.features.internetconnection.presenter.InternetConnectionView
...
val missedToolsWindowModule = module {
    ...
    factory<CollapsibleGroupView<*>>(named("internetView")) { InternetConnectionView(get(), get(), get()) }
